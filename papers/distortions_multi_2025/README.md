...
6. Model files
    ...
    2. _../../data/models/distortions/shreevastava2021-t - interpretable model created in the course of our study based on the first real field dataset (Shreevastava 2021), for three independent (overlapping) train splits (80% of the train+validation dataset, which is 80% of the entire dataset, excluding 20% holdout set) with inclusion threshold (IT) 0 based on "UFN" selection metric (SM), produced by _shreevastava_test.ipynb_, see main body of the paper.
    3. _../../data/models/distortions/shreevastava2021_ - interpretable model created in the course of our study based on the first real field dataset (Shreevastava 2021), for three independent (overlapping) train splits (80% of the entire dataset) with inclusion threshold (IT) 0 based on "FCR" selection metric (SM), produced by _shreevastava.ipynb_, see section "B Experiments without withheld test sets" of the paper.
    4. _../../data/models/distortions/shreevastava2021/joint-cleaned-10_ - joint interpretable model created based on uified and cleaned three splits of model _../../data/models/distortions/shreevastava2021_ and augmented with N-gram dictionaries provided by Bollen et al. (2021) and N-gram lists generated by ChatGPT, produced and referenced by _shreevastava_clean.ipynb_, see section "C Engineering a cleaned model" in the paper.
